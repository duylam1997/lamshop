                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mt-3 py-2 border-bottom">
                                        <img class="img-sm rounded-circle" src="/library/admin/assets/images/faces/face3.jpg" alt="profile image">
                                    ...
                                    <div class="d-flex py-2 border-bottom">
                                        <img class="img-sm rounded-circle" src="/library/admin/assets/images/faces/face4.jpg" alt="profile image">
                                        <div class="wrapper ml-2">
